...
public interface Verificator {
    ...
    //this method verify the presence of a card with the indicated color
    boolean verifyColor(CardColor color);

    ////this method verify the presence of a card with the indicated color and level
