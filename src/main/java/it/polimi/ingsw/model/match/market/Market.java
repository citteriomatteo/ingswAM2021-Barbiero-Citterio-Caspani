...
public class Market {
    ...
    public int selectRow(int numRow, Adder adder) throws NegativeQuantityException {
        int countWhite = 0;
    ...
    public int selectColumn(int numColumn, Adder adder) throws NegativeQuantityException {
        int countWhite = 0;
