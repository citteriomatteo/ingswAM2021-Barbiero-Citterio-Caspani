...
public class ExtraShelfWarehouseTest extends CommonThingsTest
{
     ...
     */
    @Test
    public void extraWarehouseDispositionTest() throws InvalidQuantityException, ShelfInsertException {
     ...
     */
    @Test
    public void fullExtraTakeTest() throws InvalidQuantityException, ShelfInsertException, NotEnoughResourcesException {
        Warehouse wh = new ConcreteWarehouse();
     ...
     */
    @Test
    public void ExtraWarehouseSwitchShelfTest() throws InvalidQuantityException, InvalidOperationException {
        Warehouse wh = new ConcreteWarehouse();
    ...
    @Test
    public void wrongBufferDiscardTest() throws SingleMatchException, WrongSettingException, InvalidQuantityException, InvalidOperationException {
    ...
    @Test
    public void cloneTest() throws InvalidQuantityException, ShelfInsertException {
        Warehouse wh = new ConcreteWarehouse();
        List<PhysicalResource> l = new ArrayList<>();
        l.add(new PhysicalResource(ResType.COIN,1));
        wh.marketDraw(l.get(0)); wh.moveInShelf(l.get(0), 1);
