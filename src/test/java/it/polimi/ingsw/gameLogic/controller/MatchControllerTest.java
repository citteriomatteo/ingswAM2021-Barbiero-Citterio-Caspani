...
import it.polimi.ingsw.gameLogic.model.essentials.leader.ProductionEffect;
import it.polimi.ingsw.gameLogic.model.essentials.leader.WhiteMarbleEffect;
...
import it.polimi.ingsw.gameLogic.model.match.market.Marble;
import it.polimi.ingsw.gameLogic.model.match.market.WhiteMarble;
...
import it.polimi.ingsw.gameLogic.model.match.player.personalBoard.warehouse.WarehouseDecorator;
...
public class MatchControllerTest extends CommonThingsTest {
    ...
    public void initialization() throws RetryException {
        ...
        setSummaries(players, map, matchConfiguration.getCustomPath(), matchConfiguration.getBasicProduction());
    ...
    public void leaderDiscardingTest() throws RetryException {
        initializationCosts();
        player = matchController.getCurrentPlayer();
        List<LeaderCard> initialLeaders = new ArrayList<>(player.getHandLeaders());
